...
import ejercicio6guia9.Service.CursoService;
...
public class Ejercicio6Guia9 {
    ...
    public static void main(String[] args) {
        ...
        CursoService curso1 = new CursoService();
        Curso primero = curso1.crearCurso();
        
        System.out.println(primero.toString());
        
        System.out.println("La ganancia del curso por semana es de : $ " + curso1.calcualarGanacia(primero));
...
por hora, la cantidad de alumnos y la cantidad de días a la semana que se repite el encuentro.
